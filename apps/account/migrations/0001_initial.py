    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marketing', models.BooleanField(default=True, null=True, verbose_name='마케팅동의여부')),
                ('last_activity', models.DateTimeField(blank=True, default=None, null=True, verbose_name='최근 활동')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('business', models.CharField(max_length=256, null=True, verbose_name='업종')),
            ],
            options={
                'verbose_name': '업종',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=256, null=True, verbose_name='직급')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateTimeField(null=True, verbose_name='클래스 종료 일자')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coin', models.IntegerField(default=2000, null=True, verbose_name='코인')),
                ...
                ('grade', models.IntegerField(choices=[(0, '파트너 X'), (1, '일반 파트너'), (2, '프리미엄 파트너')], default=0, null=True, verbose_name='파트너 등급')),
                ('real_phone', models.CharField(blank=True, max_length=32, null=True, verbose_name='실제 휴대폰 번호')),
