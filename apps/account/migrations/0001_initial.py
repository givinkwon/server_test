    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(default=apps.account.models.get_default_hash_id, max_length=50, unique=True, verbose_name='이메일')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('career', models.IntegerField(default=0, null=True, verbose_name='설립일')),
                ('employee', models.IntegerField(default=0, null=True, verbose_name='근로자수')),
                ('revenue', models.IntegerField(default=0, null=True, verbose_name='매출(백만원)')),
                ...
                ('category_big', models.ManyToManyField(related_name='category_big', to='category.Developbig', verbose_name='개발분야대분류')),
                ('category_middle', models.ManyToManyField(related_name='category_middle', to='category.Develop', verbose_name='개발분야중분류')),
